...
async function correrTests() {
  ...
  const suites = [
    ...
    await import("./suite-ceremonia.js"),
    await import("./suite-japon.js"),
    await import("./suite-distribucion.js"),
    await import("./suite-config.js"),
    await import("./suite-stats.js"),
    await import("./suite-rituales.js"),
    await import("./suite-sonido.js"),
    await import("./suite-vida.js"),
